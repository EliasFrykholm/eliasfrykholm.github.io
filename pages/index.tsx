      ...
      >
        ...
        <section id="experience">
          ...
          <WaveSection scrollOffset={offsetY} coloredComponents={coloredComponents} isTop>
            ...
            <h3 className={styles.waveSectionFooter}>
              Technologies: AWS, Java, Spring Boot, Agile, React, MongoDB, .NET, Scrum
            </h3>
          </WaveSection>
          <WaveSection scrollOffset={offsetY} coloredComponents={coloredComponents}>
            ...
            <p>
              ...
              <br />
              The result of the master thesis was that network faults could to some extent be discovered using the
              solution and could be applicable in some cases. The problems experienced were mainly due to using service
              mesh in a way it is not intended for.
            </p>
            <h3 className={styles.waveSectionFooter}>
              Technologies: Kubernetes, Service-mesh, Vagrant, Helm, Ansible, Docker, SDN, PromQL, Istio
            </h3>
          </WaveSection>
          <WaveSection scrollOffset={offsetY} coloredComponents={coloredComponents}>
            <h2>Nibe AB - Fullstack Developer</h2>
            <h3>
              Markaryd, Sweden (Remote)- June 2020 - September 2020 (Full-time) <br /> Markaryd, Sweden (Remote)-
              November 2020 - December 2020 (Part-time)
            </h3>
            <p>
              Nibe is a Swedish manufacturer with a global presence. The company develops, manufactures and sells energy
              solutions in the areas of real estate, industry and infrastructure. <br />
              <br />I was a summer intern at Nibe in 2020 which later transferred to a part-time position alongside my
              studies until it was time for my master thesis. The work was carried out remotely and i was working on an
              internal tool to be used for testing of the manufactured machines in which the machines could be remotely
              controlled. The program was developed using React.js for the frontend together with Electron and backend
              in C# .NET Core.
            </p>
            <h3 className={styles.waveSectionFooter}>
              Technologies: JavaScript, TypeScript, Redux, React.js , Electron, C#, .NET Core, Git, Jira
            </h3>
          </WaveSection>
          <WaveSection scrollOffset={offsetY} coloredComponents={coloredComponents}>
            ...
            <p>
              ...
              controllers. <br />
              <br />I was a summer intern at Calmon in 2019, responsible for an internal project of which to be used for
              demo-purposes to show the precision of their stepper motor controllers. The project involved some
              electrical engineering and programming in C++.
            </p>
            <h3 className={styles.waveSectionFooter}>Technologies: C++</h3>
          </WaveSection>
          <WaveSection scrollOffset={offsetY} coloredComponents={coloredComponents} isBottom>
            ...
            <p>
              ...
              embedded systems. <br />
              <br />
              The project is carried out in the timespan of a year. The Lund Formula student team is one of the
              top-ranking teams in Europe in the combustion section, however the competitions was canceled in 2020 due
              to covid-19. Some of the students however, continued working on the car for some time and I was one of
              them which led to the car being able to compete in 2021.
            </p>
            <h3 className={styles.waveSectionFooter}>Technologies: C++, CAN</h3>
          </WaveSection>
        </section>
        <section id="education">
          ...
          <WaveSection scrollOffset={offsetY} coloredComponents={coloredComponents} isTop>
            ...
            <p>
              Lund University the top ranked university in Sweden 2022, and one of two Swedish universities currently in
              the top 100.
              <br />
              <br />I studied the five year engineering program Computer Science and for my master, i specialized in
